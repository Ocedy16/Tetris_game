...
L = [[[1,1],[1,2],[2,2],[3,2]],[[2,1],[2,2],[1,3],[2,3]],[[1,2],[2,2],[3,2],[3,3]],[[2,1],[3,1],[2,2],[2,3]]]
...
def espace_valide(piece, grille_finie):
      ...
      if ((piece.bloc_1[0], piece.bloc_1[1]) in grille_finie) or ((piece.bloc_2[0], piece.bloc_2[1]) in grille_finie) or ((piece.bloc_3[0], piece.bloc_3[1]) in grille_finie) or ((piece.bloc_4[0], piece.bloc_4[1]) in grille_finie) or (piece.bloc_1[0] < 0) or (piece.bloc_1[0] > 9) or (piece.bloc_1[1]< 0) or (piece.bloc_1[1]> 19) or (piece.bloc_2[0] < 0) or (piece.bloc_2[0] > 9) or (piece.bloc_2[1]< 0) or (piece.bloc_2[1]> 19) or (piece.bloc_3[0] < 0) or (piece.bloc_3[0] > 9) or (piece.bloc_3[1]< 0) or (piece.bloc_3[1]> 19) or (piece.bloc_4[0] < 0) or (piece.bloc_4[0] > 9) or (piece.bloc_4[1]< 0) or (piece.bloc_4[1]> 19) : :
            return False
      else :
            return True
...
def main():
    ...
    while running==True:
      ...
      if time_elapsed_since_last_action > 1000:
            ...
            piece.y += 1
            piece.deplacer()
            if not (espace_valide(piece, grille)) and piece.y > 0:
                piece.y -= 1
                piece.deplacer()
